...
internal val soxAudioInputStreamProvider =
    AudioStreamProvider { audioInterfaceName ->
        val cmd =
            """
...
internal val soxAudioOutputStreamProvider =
    AudioStreamProvider { audioInterfaceName ->
        val cmd =
            """
...
internal val soxDebugAudioStreamProvider =
    AudioStreamProvider {
